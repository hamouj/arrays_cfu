...
puts true_statements

# Unshift inserts an element(s) into the beginning of the array.
puts favorite_starbucks_items.unshift ["water"]
puts favorite_starbucks_items

# -------------------Index Positions----------------------
# Instead of starting with 1, we start at 0 when counting positions in an array--this is called index positions.
...
# By calling the reverse method on the birth_months array, the output is a reversal of the birth month elements within the array [6,5,4]